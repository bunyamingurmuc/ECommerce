...
namespace ECommerce.API.Controllers
{
    ...
    public class OrderItemController : ControllerBase
    {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public ActionResult Update(OrderItem entity)
        {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsycn(OrderItem entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsycn(OrderItem entity)
        {
