...
namespace ECommerce.API.Views.mails
{
    public static class EmailMarketingTemplateGenerator
    {
        public static string CardReminderGenerator(Card card, AppUser user)
        {
		...
		<div style=""max-width: 600px; margin: 0 auto;"" class=""email-container"">
						...
						<table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" width=""100%"">
							<tr>
								<td style=""padding: 0 2.5em; text-align: left;"">
									<div class=""text"">
										<h2>{0} your shopping cart misses you</h2>
            ...
            foreach (var cardItem in card.CardItems)
            {
                sb.AppendFormat(@"
						...
						</tr>", cardItem.Product.Images[0].Base64Url, cardItem.Product.Name, cardItem.Product.Category.Name, cardItem.Product.Description);
            }
