...
namespace ECommerce.API.Controllers
{
    ...
    public class SellerController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public IActionResult Create(Seller entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public ActionResult Update(Seller entity)
        {
        ...
        [HttpPost]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> CreateAsycn(Seller entity)
        {
        ...
        [HttpPut]
        [Route("/[controller]/[action]")]
        public async Task<ActionResult> UpdateAsycn(Seller entity)
        {
